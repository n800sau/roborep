...
#----------------------------------------------------------------------#
PINS = {
	'E': 'P8_13',   # pin 6 on LCD
	'RS': 'P8_15',  # pin 4 on LCD
	'DB7': 'P8_8',  # pin 14 on LCD
	'DB6': 'P8_10', # pin 13 on LCD
	'DB5': 'P8_12', # pin 12 on LCD
	'DB4': 'P8_14', # pin 11 on LCD
	'DB3':'',       # pin 10 on LCD
	'DB2':'',       # pin 9 on LCD
	'DB1':'',       # pin 8 on LCD
	'DB0':'',       # pin 7 on LCD
...
if __name__ == '__main__':
	s = Screen(bit_mode=4)
	s.clear()
	s.printLine('Line 1', line_number=1)
	s.printLine('Line 2', line_number=2)
