...
class LicensePlateDetector:
	def __init__(self, image, minPlateW=40, minPlateH=10, maxPlateW=160, maxPlateH=40):
		...
		self.maxPlateW = maxPlateW
		self.maxPlateH = maxPlateH
...
#			print 'AR:', aspectRatio
			...
			if (aspectRatio > 3 and aspectRatio < 6) and h > self.minPlateH and w > self.minPlateW and h < self.maxPlateH and w < self.maxPlateW:
				regions.append(box)

		# return the list of license plate regions
		return {'regions': regions, 'images': images}
