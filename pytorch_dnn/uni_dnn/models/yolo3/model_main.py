...
class Yolo3(nn.Module):
	def __init__(self, config, backbone_name='darknet_53', backbone_weights_path=None, is_training=True):
		super(Yolo3, self).__init__()
		self.config = config
		self.training = is_training
		#  backbone
		self.backbone = backbone_fn[backbone_name]()
		if backbone_weights_path and os.path.exists(backbone_weights_path):
			print("Load backbone weights from {}".format(backbone_weights_path))
...
if __name__ == "__main__":
	m = Yolo3(backbone_name = "darknet_53")
