...
const char *RF24::num2str(int val, const char * const arr[])
{
	const char *rs;
	for(int i=0; i<=val; i++) {
		rs = arr[i];
...
#if defined(__arm__) || defined (ARDUINO_ARCH_ESP8266) || defined (RF24_LINUX) || defined (__ARDUINO_X86__) || defined(LITTLEWIRE) || defined (RF24_BBB)
  printf_P(PSTR("Data Rate\t = %s\r\n"),num2str(getDataRate(), rf24_datarate_e_str_P));
  printf_P(PSTR("Model\t\t = %s\r\n"),num2str(isPVariant(), rf24_model_e_str_P));
  printf_P(PSTR("CRC Length\t = %s\r\n"),num2str(getCRCLength(), rf24_crclength_e_str_P));
  printf_P(PSTR("PA Power\t = %s\r\n"),  num2str(getPALevel(), rf24_pa_dbm_e_str_P));
#else
  printf_P(PSTR("Data Rate\t = %S\r\n"), num2str(getDataRate(), rf24_datarate_e_str_P));
  printf_P(PSTR("Model\t\t = %S\r\n"),   num2str(isPVariant(), rf24_model_e_str_P));
  printf_P(PSTR("CRC Length\t = %S\r\n"),num2str(getCRCLength(), rf24_crclength_e_str_P));
