...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 70.0 // Default 78.0mm
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way. Modified for TMC2100(2130)
#define INVERT_X_DIR true // DELTA does not invert. set to true for A4988
#define INVERT_Y_DIR true // set to true for A4988
#define INVERT_Z_DIR true // set to true for A4988
...
// For direct drive extruder v9 set to true, for geared extruder set to false. Modified for TMC2100(2130)
#define INVERT_E0_DIR true // set to true for A4988
