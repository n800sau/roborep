...
void pinMode(struct gpioID *singlePin,int pinID, const char *direction)
{
	...
	switch (pinID)
	{
		...
		case P8_8:
			...
			strcpy(singlePin->GPIOMUX, "gpmc_oen_ren");
		...
		case P8_10:
			...
			strcpy(singlePin->GPIOMUX, "gpmc_wen");
			singlePin->GPIONUMBER=68;
			break;

		case P8_13:
			strcpy(singlePin->PINNAME, "P8_13");
			strcpy(singlePin->GPIOID, "gpio0[23]");
			strcpy(singlePin->GPIOMUX, "gpmc_ad9");
			singlePin->GPIONUMBER=0;
			break;

		case P9_14:
			strcpy(singlePin->PINNAME, "P9_14");
			strcpy(singlePin->GPIOID, "gpio1[18]");
			strcpy(singlePin->GPIOMUX, "gpmc_a2");
			singlePin->GPIONUMBER=0;
			break;
