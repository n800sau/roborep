...
module pipette_top_holder() {
	translate([0, pipette_center_off_y-attach_sz_y/2-gantry_sz_y/2, pipette_top_holder_sz_z/2+attach_sz_z/2]) {
		difference() {
			union() {
				translate([0, pipette_center_off_y, top_sz_z/2]) {
					for(x=[-1,1]) {
						translate([x*(holder_sz_x+wall+1)/2, -pipette_center_off_y-5, attach_sz_z/2]) {
							difference() {
								cube([wall, holder_sz_y/2+10, attach_sz_z/2], center=true);
								translate([0, -(holder_sz_y/2+10)/2, -pipette_top_holder_sz_z]) {
									cube([20, holder_sz_y/2+10, attach_sz_z/2], center=true);
								}
							}
						}
						translate([0, 0, attach_sz_z+pipette_top_holder_sz_z]) {
							difference() {
...
//					cube([16, 20, pipette_top_holder_sz_z], center=true);
			...
			translate([0, -default_attach_extra_sz_y-(pipette_center_off_y-attach_sz_y/2-gantry_sz_y/2), -pipette_top_holder_sz_z/2]) {
