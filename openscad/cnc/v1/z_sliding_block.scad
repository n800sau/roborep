...
module slider_z_adapter(side="all", extra_sz_y=default_attach_extra_sz_y, extra_sz_z=0) {
...
if(show_part2) {
	slider_z_adapter(side="left", extra_sz_y=default_attach_extra_sz_y, extra_sz_z=attach_sz_z+10+26);
}
if(show_part3) {
	slider_z_adapter(side="right", extra_sz_y=default_attach_extra_sz_y, extra_sz_z=attach_sz_z+10+26);
}
// does not fit
translate([0, 10,0]) {
	//	adapter_bracket();
