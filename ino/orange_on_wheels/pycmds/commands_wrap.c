...
/*-----------------------------------------------
              @(target):= _libcommands_py.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__libcommands_py

#else
#  define SWIG_init    init_libcommands_py

#endif
#define SWIG_name    "_libcommands_py"
...
#include "../lib/SerialProtocol/constants.h"
...
# endif
  ...
  SWIG_Python_SetConstant(d, "C_PING",SWIG_From_int((int)(C_PING)));
  SWIG_Python_SetConstant(d, "C_STATE",SWIG_From_int((int)(C_STATE)));
  SWIG_Python_SetConstant(d, "C_MLEFT",SWIG_From_int((int)(C_MLEFT)));
  SWIG_Python_SetConstant(d, "C_MRIGHT",SWIG_From_int((int)(C_MRIGHT)));
  SWIG_Python_SetConstant(d, "C_MBOTH",SWIG_From_int((int)(C_MBOTH)));
  ...
  SWIG_Python_SetConstant(d, "R_COMMAND_1F",SWIG_From_int((int)(R_COMMAND_1F)));
